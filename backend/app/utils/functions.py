...
def extract_fields(text):
    ...
    try:
        ...
        logger.error(f"[EXTRACT-FIELDS] Error procesando texto: {str(e)}", exc_info=True)
        logger.error(f"[EXTRACT-FIELDS] Texto que causó el error: {text}")
        raise